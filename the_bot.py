...
- Просмотр погоды на следующие дни прикрутить не успел;
- Использован API от OWM.
- Присутствует проблема при введении '/start' два раза подряд. Причину установить не удалось. Буду благодарен за
 подсказку."""
